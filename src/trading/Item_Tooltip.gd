...
func replace_tooltip_display(new_tooltip : Dictionary = {}, node = null) -> void:
	...
	if ( not tooltip_item == node ) and ( node != null ):
		...
		tooltip_container.get_node("Title").text = new_tooltip.get("display_name")
		...
		tooltip_container.get_node("Description").set_text("\"%s\"" % new_tooltip.get("description"))
...
func replace_compare_tooltip(new_compare, node = null):
	...
	if ( not compared_item == node ) and ( node != null ):
		...
		compare_container.get_node("Title").text = new_compare.get("display_name")
		...
		compare_container.get_node("Description").set_text("\"%s\"" % new_compare.get("description"))
